...
urlpatterns = [
    ...
    path(
        "product_detail/<int:pk>/<str:clr>", views.product_detail, name="product_detail"
    ),
    ...
    path(
        "addsubcategory/<int:pk>/", views.add_sub_category, name="add_sub_categorynew"
    ),
    path("addsubcategory/<int:pk>/", views.edit_sub_category, name="edit_sub_category"),
    path(
        "delsubcategory/<int:pk>/", views.delete_sub_category, name="deletesubCategory"
    ),
    # multiple images
    ...
    path(
        "includedDelSubCat/",
        views.view_deleted_subcategories,
        name="included_del_subcat",
    ),
    path(
        "restoreSubCategory/<int:pk>/",
        views.restoreSubCategory,
        name="restoreSubCategory",
    ),
    ...
    path(
        "product_return_status/<int:pk>/",
        views.product_return_status,
        name="product_return_status",
    ),
    # reset password
    ...
    path(
        "change_order_status/<int:pk>/",
        views.admin_change_order_status,
        name="change_order_status",
    ),
    # admin inventory
    path(
        "admin_inventory_list/", views.admin_inventory_list, name="admin_inventory_list"
    ),
    path(
        "add_product_stock/<int:pk>/",
        views.admin_add_product_stock,
    ...
    path(
        "admin_variant_view/<int:pk>/",
        views.admin_variant_view,
    ...
    path(
        "activate_category_offer/<int:pk>/",
        views.activate_category_offer,
        name="activate_category_offer",
    ),
]
